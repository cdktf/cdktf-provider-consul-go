...
func (c *jsiiProxy_ConfigEntryServiceResolverFailoverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceResolverFailoverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
