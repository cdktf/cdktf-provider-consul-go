...
func (c *jsiiProxy_ConfigEntryServiceResolverLoadBalancerHashPoliciesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceResolverLoadBalancerHashPoliciesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
