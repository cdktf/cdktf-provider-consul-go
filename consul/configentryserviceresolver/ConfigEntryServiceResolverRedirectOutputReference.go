...
func (c *jsiiProxy_ConfigEntryServiceResolverRedirectOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceResolverRedirectOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
