...
func (c *jsiiProxy_ConfigEntryServiceResolverLoadBalancerLeastRequestConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigEntryServiceResolverLoadBalancerLeastRequestConfigList) Resolve(context cdktf.IResolveContext) interface{} {
