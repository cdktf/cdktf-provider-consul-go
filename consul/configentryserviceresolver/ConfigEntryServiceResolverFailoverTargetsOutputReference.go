...
func (c *jsiiProxy_ConfigEntryServiceResolverFailoverTargetsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceResolverFailoverTargetsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
