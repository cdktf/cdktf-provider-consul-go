...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v3/dataconsulagentself/internal"
...
func (j *jsiiProxy_DataConsulAgentSelf) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_DataConsulAgentSelf)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
