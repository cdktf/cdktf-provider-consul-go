...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v10/dataconsulagentself/internal"
...
func DataConsulAgentSelf_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataConsulAgentSelf_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataConsulAgentSelf) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataConsulAgentSelf) ToHclTerraform() interface{} {
	var returns interface{}
