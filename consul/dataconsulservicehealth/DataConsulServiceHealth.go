...
func (d *jsiiProxy_DataConsulServiceHealth) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataConsulServiceHealth) ToHclTerraform() interface{} {
	var returns interface{}
