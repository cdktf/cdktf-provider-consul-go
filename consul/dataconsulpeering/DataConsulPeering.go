...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v10/dataconsulpeering/internal"
...
func (j *jsiiProxy_DataConsulPeering) Count() interface{} {
...
func (j *jsiiProxy_DataConsulPeering)SetCount(val interface{}) {
...
func DataConsulPeering_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataConsulPeering_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataConsulPeering) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataConsulPeering) ToHclTerraform() interface{} {
	var returns interface{}
