...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/dataconsulpeering/internal"
...
func (j *jsiiProxy_DataConsulPeering) ExportedServiceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataConsulPeering) ImportedServiceCount() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
