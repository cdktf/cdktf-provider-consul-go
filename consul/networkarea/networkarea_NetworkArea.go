...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v3/networkarea/internal"
...
type NetworkArea interface {
	...
	SetPeerDatacenter(val *string)
	PeerDatacenterInput() *string
	// Experimental.
	...
	RetryJoin() *[]*string
	SetRetryJoin(val *[]*string)
	RetryJoinInput() *[]*string
	// Experimental.
	...
	TokenInput() *string
	UseTls() interface{}
	SetUseTls(val interface{})
	UseTlsInput() interface{}
	// Experimental.
...
func (j *jsiiProxy_NetworkArea) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_NetworkArea) Datacenter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenter",
...
func (j *jsiiProxy_NetworkArea) DatacenterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterInput",
...
func (j *jsiiProxy_NetworkArea) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkArea) PeerDatacenter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerDatacenter",
...
func (j *jsiiProxy_NetworkArea) PeerDatacenterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"peerDatacenterInput",
...
func (j *jsiiProxy_NetworkArea) RetryJoin() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"retryJoin",
...
func (j *jsiiProxy_NetworkArea) RetryJoinInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"retryJoinInput",
...
func (j *jsiiProxy_NetworkArea) Token() *string {
	var returns *string
	_jsii_.Get(
		j,
		"token",
...
func (j *jsiiProxy_NetworkArea) TokenInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenInput",
...
func (j *jsiiProxy_NetworkArea) UseTls() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"useTls",
...
func (j *jsiiProxy_NetworkArea) UseTlsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"useTlsInput",
...
func NewNetworkArea(scope constructs.Construct, id *string, config *NetworkAreaConfig) NetworkArea {
	...
	_jsii_.Create(
		"@cdktf/provider-consul.networkArea.NetworkArea",
...
func (j *jsiiProxy_NetworkArea)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
...
func (j *jsiiProxy_NetworkArea)SetDatacenter(val *string) {
...
func (j *jsiiProxy_NetworkArea)SetId(val *string) {
...
func (j *jsiiProxy_NetworkArea)SetPeerDatacenter(val *string) {
	if err := j.validateSetPeerDatacenterParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_NetworkArea)SetRetryJoin(val *[]*string) {
	if err := j.validateSetRetryJoinParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_NetworkArea)SetToken(val *string) {
...
func (j *jsiiProxy_NetworkArea)SetUseTls(val interface{}) {
	if err := j.validateSetUseTlsParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (n *jsiiProxy_NetworkArea) ResetDatacenter() {
	_jsii_.InvokeVoid(
		n,
		"resetDatacenter",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkArea) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkArea) ResetRetryJoin() {
	_jsii_.InvokeVoid(
		n,
		"resetRetryJoin",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkArea) ResetToken() {
	_jsii_.InvokeVoid(
		n,
		"resetToken",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkArea) ResetUseTls() {
	_jsii_.InvokeVoid(
		n,
		"resetUseTls",
		nil, // no parameters
