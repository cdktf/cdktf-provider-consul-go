...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesMatchHttpQueryParamOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesMatchHttpQueryParamOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
