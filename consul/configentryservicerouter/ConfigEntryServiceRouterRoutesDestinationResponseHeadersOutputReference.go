...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesDestinationResponseHeadersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesDestinationResponseHeadersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
