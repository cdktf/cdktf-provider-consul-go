...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesMatchHttpOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesMatchHttpOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
