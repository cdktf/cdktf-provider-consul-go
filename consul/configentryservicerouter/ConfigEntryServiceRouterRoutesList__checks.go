...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_ConfigEntryServiceRouterRoutesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
