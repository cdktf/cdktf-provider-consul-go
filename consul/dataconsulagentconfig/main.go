...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulAgentConfig)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulAgentConfig.DataConsulAgentConfigConfig",
		reflect.TypeOf((*DataConsulAgentConfigConfig)(nil)).Elem(),
	)
}
