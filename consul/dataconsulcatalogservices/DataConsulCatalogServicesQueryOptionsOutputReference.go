...
func (d *jsiiProxy_DataConsulCatalogServicesQueryOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataConsulCatalogServicesQueryOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
