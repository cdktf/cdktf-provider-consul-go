...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulCatalogServices)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulCatalogServices.DataConsulCatalogServicesConfig",
		reflect.TypeOf((*DataConsulCatalogServicesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulCatalogServices.DataConsulCatalogServicesQueryOptions",
		reflect.TypeOf((*DataConsulCatalogServicesQueryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulCatalogServices.DataConsulCatalogServicesQueryOptionsList",
		reflect.TypeOf((*DataConsulCatalogServicesQueryOptionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulCatalogServicesQueryOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
