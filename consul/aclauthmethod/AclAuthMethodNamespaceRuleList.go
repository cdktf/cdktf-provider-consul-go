...
func (a *jsiiProxy_AclAuthMethodNamespaceRuleList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (a *jsiiProxy_AclAuthMethodNamespaceRuleList) Resolve(context cdktf.IResolveContext) interface{} {
