...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "namespaceRule", GoGetter: "NamespaceRule"},
			_jsii_.MemberProperty{JsiiProperty: "namespaceRuleInput", GoGetter: "NamespaceRuleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putNamespaceRule", GoMethod: "PutNamespaceRule"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetConfig", GoMethod: "ResetConfig"},
			_jsii_.MemberMethod{JsiiMethod: "resetConfigJson", GoMethod: "ResetConfigJson"},
			_jsii_.MemberMethod{JsiiMethod: "resetDescription", GoMethod: "ResetDescription"},
			_jsii_.MemberMethod{JsiiMethod: "resetDisplayName", GoMethod: "ResetDisplayName"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetMaxTokenTtl", GoMethod: "ResetMaxTokenTtl"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespace", GoMethod: "ResetNamespace"},
			_jsii_.MemberMethod{JsiiMethod: "resetNamespaceRule", GoMethod: "ResetNamespaceRule"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetPartition", GoMethod: "ResetPartition"},
			_jsii_.MemberMethod{JsiiMethod: "resetTokenLocality", GoMethod: "ResetTokenLocality"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.aclAuthMethod.AclAuthMethodConfig",
		reflect.TypeOf((*AclAuthMethodConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.aclAuthMethod.AclAuthMethodNamespaceRule",
		reflect.TypeOf((*AclAuthMethodNamespaceRule)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.aclAuthMethod.AclAuthMethodNamespaceRuleList",
		reflect.TypeOf((*AclAuthMethodNamespaceRuleList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AclAuthMethodNamespaceRuleOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "bindNamespace", GoGetter: "BindNamespace"},
			_jsii_.MemberProperty{JsiiProperty: "bindNamespaceInput", GoGetter: "BindNamespaceInput"},
