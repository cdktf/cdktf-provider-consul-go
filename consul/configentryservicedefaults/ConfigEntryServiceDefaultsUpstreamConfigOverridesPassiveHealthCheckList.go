...
func (c *jsiiProxy_ConfigEntryServiceDefaultsUpstreamConfigOverridesPassiveHealthCheckList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigEntryServiceDefaultsUpstreamConfigOverridesPassiveHealthCheckList) Resolve(context cdktf.IResolveContext) interface{} {
