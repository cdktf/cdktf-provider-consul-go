...
func (c *jsiiProxy_ConfigEntryServiceDefaultsExposeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceDefaultsExposeOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
