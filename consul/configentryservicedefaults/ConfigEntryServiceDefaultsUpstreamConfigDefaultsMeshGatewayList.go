...
func (c *jsiiProxy_ConfigEntryServiceDefaultsUpstreamConfigDefaultsMeshGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ConfigEntryServiceDefaultsUpstreamConfigDefaultsMeshGatewayList) Resolve(context cdktf.IResolveContext) interface{} {
