...
func PreparedQuery_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validatePreparedQuery_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_PreparedQuery) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_PreparedQuery) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_PreparedQuery) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_PreparedQuery) MoveFromId(id *string) {
...
func (p *jsiiProxy_PreparedQuery) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_PreparedQuery) MoveToId(id *string) {
...
func (p *jsiiProxy_PreparedQuery) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_PreparedQuery) ToHclTerraform() interface{} {
	var returns interface{}
