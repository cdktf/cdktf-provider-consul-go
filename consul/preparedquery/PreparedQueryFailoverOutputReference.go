...
func (p *jsiiProxy_PreparedQueryFailoverOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_PreparedQueryFailoverOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
