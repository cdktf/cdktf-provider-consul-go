...
func (p *jsiiProxy_PreparedQueryFailoverTargetsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (p *jsiiProxy_PreparedQueryFailoverTargetsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
