...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulService)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulService.DataConsulServiceConfig",
		reflect.TypeOf((*DataConsulServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulService.DataConsulServiceQueryOptions",
		reflect.TypeOf((*DataConsulServiceQueryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulService.DataConsulServiceQueryOptionsList",
		reflect.TypeOf((*DataConsulServiceQueryOptionsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulServiceQueryOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulService.DataConsulServiceService",
		reflect.TypeOf((*DataConsulServiceService)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulService.DataConsulServiceServiceList",
		reflect.TypeOf((*DataConsulServiceServiceList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulServiceServiceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
