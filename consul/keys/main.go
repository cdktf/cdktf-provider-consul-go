...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.keys.KeysConfig",
		reflect.TypeOf((*KeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.keys.KeysKey",
		reflect.TypeOf((*KeysKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.keys.KeysKeyList",
		reflect.TypeOf((*KeysKeyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KeysKeyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
