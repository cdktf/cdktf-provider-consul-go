...
func (d *jsiiProxy_DataConsulKeysKeyList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataConsulKeysKeyList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
