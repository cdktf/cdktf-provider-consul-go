...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNetworkSegments)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNetworkSegments.DataConsulNetworkSegmentsConfig",
		reflect.TypeOf((*DataConsulNetworkSegmentsConfig)(nil)).Elem(),
	)
}
