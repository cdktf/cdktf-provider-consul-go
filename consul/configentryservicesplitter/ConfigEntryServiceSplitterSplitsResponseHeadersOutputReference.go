...
func (c *jsiiProxy_ConfigEntryServiceSplitterSplitsResponseHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceSplitterSplitsResponseHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
