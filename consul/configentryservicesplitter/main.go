...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConfigEntryServiceSplitter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterConfig",
		reflect.TypeOf((*ConfigEntryServiceSplitterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplits",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplits)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplitsList",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplitsRequestHeaders",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsRequestHeaders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplitsRequestHeadersOutputReference",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsRequestHeadersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplitsResponseHeaders",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsResponseHeaders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.configEntryServiceSplitter.ConfigEntryServiceSplitterSplitsResponseHeadersOutputReference",
		reflect.TypeOf((*ConfigEntryServiceSplitterSplitsResponseHeadersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "add", GoGetter: "Add"},
			_jsii_.MemberProperty{JsiiProperty: "addInput", GoGetter: "AddInput"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
