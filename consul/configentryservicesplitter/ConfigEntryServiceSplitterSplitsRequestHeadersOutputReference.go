...
func (c *jsiiProxy_ConfigEntryServiceSplitterSplitsRequestHeadersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ConfigEntryServiceSplitterSplitsRequestHeadersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
