...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*PeeringToken)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peeringToken", GoGetter: "PeeringToken"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetServerExternalAddresses", GoMethod: "ResetServerExternalAddresses"},
			_jsii_.MemberProperty{JsiiProperty: "serverExternalAddresses", GoGetter: "ServerExternalAddresses"},
			_jsii_.MemberProperty{JsiiProperty: "serverExternalAddressesInput", GoGetter: "ServerExternalAddressesInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.peeringToken.PeeringTokenConfig",
		reflect.TypeOf((*PeeringTokenConfig)(nil)).Elem(),
	)
}
