...
func (d *jsiiProxy_DataConsulAclTokenServiceIdentitiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataConsulAclTokenServiceIdentitiesList) Resolve(context cdktf.IResolveContext) interface{} {
