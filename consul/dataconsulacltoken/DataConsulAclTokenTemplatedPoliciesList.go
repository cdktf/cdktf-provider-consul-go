...
func (d *jsiiProxy_DataConsulAclTokenTemplatedPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataConsulAclTokenTemplatedPoliciesList) Resolve(context cdktf.IResolveContext) interface{} {
