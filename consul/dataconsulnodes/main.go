...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNodes)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNodes.DataConsulNodesConfig",
		reflect.TypeOf((*DataConsulNodesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNodes.DataConsulNodesNodes",
		reflect.TypeOf((*DataConsulNodesNodes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulNodes.DataConsulNodesNodesList",
		reflect.TypeOf((*DataConsulNodesNodesList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNodesNodesOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNodes.DataConsulNodesQueryOptions",
		reflect.TypeOf((*DataConsulNodesQueryOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulNodes.DataConsulNodesQueryOptionsList",
		reflect.TypeOf((*DataConsulNodesQueryOptionsList)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "allWithMapKey", GoMethod: "AllWithMapKey"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNodesQueryOptionsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
