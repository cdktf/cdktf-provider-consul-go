...
func (d *jsiiProxy_DataConsulNodesQueryOptionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataConsulNodesQueryOptionsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
