...
func (d *jsiiProxy_DataConsulNodesQueryOptionsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataConsulNodesQueryOptionsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
