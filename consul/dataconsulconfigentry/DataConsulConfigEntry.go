...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v10/dataconsulconfigentry/internal"
...
func (j *jsiiProxy_DataConsulConfigEntry) Count() interface{} {
...
func (j *jsiiProxy_DataConsulConfigEntry)SetCount(val interface{}) {
...
func DataConsulConfigEntry_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataConsulConfigEntry_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataConsulConfigEntry) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataConsulConfigEntry) ToHclTerraform() interface{} {
	var returns interface{}
