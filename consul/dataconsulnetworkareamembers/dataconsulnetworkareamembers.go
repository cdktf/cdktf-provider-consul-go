...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNetworkAreaMembers)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNetworkAreaMembers.DataConsulNetworkAreaMembersConfig",
		reflect.TypeOf((*DataConsulNetworkAreaMembersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.dataConsulNetworkAreaMembers.DataConsulNetworkAreaMembersMembers",
		reflect.TypeOf((*DataConsulNetworkAreaMembersMembers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.dataConsulNetworkAreaMembers.DataConsulNetworkAreaMembersMembersList",
		reflect.TypeOf((*DataConsulNetworkAreaMembersMembersList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataConsulNetworkAreaMembersMembersOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "rtt", GoGetter: "Rtt"},
