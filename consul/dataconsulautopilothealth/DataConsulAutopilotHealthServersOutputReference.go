...
func (d *jsiiProxy_DataConsulAutopilotHealthServersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataConsulAutopilotHealthServersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
