...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Peering)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "peeringTokenInput", GoGetter: "PeeringTokenInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.peering.PeeringConfig",
