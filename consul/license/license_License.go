...
import (
	...
	"github.com/cdktf/cdktf-provider-consul-go/consul/v3/license/internal"
...
func (j *jsiiProxy_License) CustomerId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"customerId",
...
func (j *jsiiProxy_License) Datacenter() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenter",
...
func (j *jsiiProxy_License) DatacenterInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"datacenterInput",
...
func (j *jsiiProxy_License) ExpirationTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"expirationTime",
...
func (j *jsiiProxy_License) Features() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"features",
...
func (j *jsiiProxy_License) InstallationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"installationId",
...
func (j *jsiiProxy_License) IssueTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"issueTime",
...
func (j *jsiiProxy_License) License() *string {
	var returns *string
	_jsii_.Get(
		j,
		"license",
...
func (j *jsiiProxy_License) LicenseId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"licenseId",
...
func (j *jsiiProxy_License) LicenseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"licenseInput",
...
func (j *jsiiProxy_License) Product() *string {
	var returns *string
	_jsii_.Get(
		j,
		"product",
...
func (j *jsiiProxy_License) StartTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"startTime",
...
func (j *jsiiProxy_License) Valid() cdktf.IResolvable {
...
func (j *jsiiProxy_License) Warnings() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"warnings",
...
func NewLicense(scope constructs.Construct, id *string, config *LicenseConfig) License {
	...
	_jsii_.Create(
		"@cdktf/provider-consul.license.License",
...
func (j *jsiiProxy_License)SetDatacenter(val *string) {
...
func (j *jsiiProxy_License)SetLicense(val *string) {
...
func (l *jsiiProxy_License) ResetDatacenter() {
	_jsii_.InvokeVoid(
		l,
		"resetDatacenter",
		nil, // no parameters
