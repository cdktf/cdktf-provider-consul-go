...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*LicenseResource)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "issueTime", GoGetter: "IssueTime"},
			_jsii_.MemberProperty{JsiiProperty: "license", GoGetter: "License"},
			_jsii_.MemberProperty{JsiiProperty: "licenseId", GoGetter: "LicenseId"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.licenseResource.LicenseResourceConfig",
		reflect.TypeOf((*LicenseResourceConfig)(nil)).Elem(),
	)
}
