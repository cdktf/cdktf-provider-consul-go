...
func (j *jsiiProxy_ConsulProvider) validateSetHeaderParameters(val interface{}) error {
	...
	case cdktf.IResolvable:
		// ok
	case *[]*ConsulProviderHeader:
		val := val.(*[]*ConsulProviderHeader)
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ConsulProviderHeader; received %#v (a %T)", val, val)
		}
	}
