...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KeyPrefix)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSubkeys", GoMethod: "ResetSubkeys"},
			...
			_jsii_.MemberProperty{JsiiProperty: "subkeysInput", GoGetter: "SubkeysInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.keyPrefix.KeyPrefixConfig",
		reflect.TypeOf((*KeyPrefixConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.keyPrefix.KeyPrefixSubkey",
		reflect.TypeOf((*KeyPrefixSubkey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.keyPrefix.KeyPrefixSubkeyList",
		reflect.TypeOf((*KeyPrefixSubkeyList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*KeyPrefixSubkeyOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
