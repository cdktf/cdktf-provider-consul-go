...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.catalogEntry.CatalogEntryConfig",
		reflect.TypeOf((*CatalogEntryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-consul.catalogEntry.CatalogEntryService",
		reflect.TypeOf((*CatalogEntryService)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-consul.catalogEntry.CatalogEntryServiceList",
		reflect.TypeOf((*CatalogEntryServiceList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CatalogEntryServiceOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "address", GoGetter: "Address"},
			_jsii_.MemberProperty{JsiiProperty: "addressInput", GoGetter: "AddressInput"},
