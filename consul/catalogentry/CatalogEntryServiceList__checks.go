...
func (c *jsiiProxy_CatalogEntryServiceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (c *jsiiProxy_CatalogEntryServiceList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
