...
func (c *jsiiProxy_CatalogEntry) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (c *jsiiProxy_CatalogEntry) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (c *jsiiProxy_CatalogEntry) validatePutServiceParameters(value interface{}) error {
	...
	case *[]*CatalogEntryService:
		value := value.(*[]*CatalogEntryService)
	...
	case []*CatalogEntryService:
		value_ := value.([]*CatalogEntryService)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*CatalogEntryService; received %#v (a %T)", value, value)
		}
	}
