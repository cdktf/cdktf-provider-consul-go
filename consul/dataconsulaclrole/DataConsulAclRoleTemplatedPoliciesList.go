...
func (d *jsiiProxy_DataConsulAclRoleTemplatedPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataConsulAclRoleTemplatedPoliciesList) Resolve(context cdktf.IResolveContext) interface{} {
