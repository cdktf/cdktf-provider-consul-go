...
func (s *jsiiProxy_ServiceCheckOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceCheckOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
