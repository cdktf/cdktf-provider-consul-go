...
func (s *jsiiProxy_Service) validatePutCheckParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ServiceCheck; received %#v (a %T)", value, value)
		}
	}
