// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for consul.
...
// You can continue to use the consul provider in your CDK for Terraform projects with newer versions of CDKTF,
// but you will need to generate the bindings locally. See https://cdk.tf/imports for details.
module github.com/cdktf/cdktf-provider-consul-go/consul/v10
